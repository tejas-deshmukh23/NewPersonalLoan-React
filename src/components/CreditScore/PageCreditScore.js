     ...
     <div class="row">
      ...
      <div class="row">
		...
		<div class="row">
            <div class="col-md-12">
                <div class="input-group mb-3">
                  <input type="text" style={{display: "block",width:"100%",textTransform:"uppercase"
						...
						<div class="row send" style={{display:"block"}}>
							<div class="col-md-12" style={{buttonColor: "#3e2780"}}>
								...
								<div class="btn btn-primary createaccount-home_btn text-center"
									style={{marginTop:"20px",width:"100%",background:"#3e2780", color:"#32e70",border: "1px solid #eee",
  ...
  color: '#18181C'}}>  
        ...
        <AccordionDetails>
          <Typography sx={{
             fontFamily: 'Noto Sans',fontStyle:'normal',fontWeight:500,fontSize:'16px',
             lineHeight: '27px',letterSpacing: '0.02em',color: '#18181C'}}>  
 Though credit score is not the only thing that lenders look at when considering a loan or credit card application, it is arguably one of the most important ones. Maintaining a good credit score comes with several benefits that include:<br/><br/>
                      
                      Greater chances of your loan applications being approved, as a high Credit score indicates higher creditworthiness and lower risk for the lender<br/><br/>
