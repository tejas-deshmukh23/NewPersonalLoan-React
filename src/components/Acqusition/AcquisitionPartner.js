     ...
     <section class="container banner" style={{paddingTop:"8%",paddingBottom:"8%"}}>
      <div class="row">
        ...
        <div class="col-md-6 text-center">
          <figure class="figure">
            <a href="https://india1payments.in/"><img src="https://credithaatimages.s3.ap-south-1.amazonaws.com/siteimages/India1-Logo.png" class="figure-img img-fluid banner_img" alt="..." /></a>
          </figure>
        </div>
      </div>
    </section>
